...
//VERSION IS 0.3 IF YOUR MENU DOES NOT SAY THAT PLEASE UPDATE BY CLICKING INSTALL AND COPYING THE CODE
...
// @version      0.3
// @description  VERSION IS 0.3 IF YOUR MENU DOES NOT SAY THAT PLEASE UPDATE BY CLICKING INSTALL AND COPYING THE CODE IN devilmenuXD AND OPENING TAMPER MONKEY(in extentions)
// @author       snowiscool
// @match        *://*/*
    ...
    if (event.keyCode === 220) {
        ...
        <div id="box">
            ...
            <div class="ou" id="box2">
                <p style="color:red;"> Demon menu(0.3)</p>
            ...
            //end of skin stuff
              ...
              if ( document.URL.includes("https://www.musictheory.net/exercises/note") ) {
                  alert("automaticly injected");
